...
<link rel="stylesheet" type="text/css" href="{{asset('assets/global/css/j-forms.css')}}"/>
...
<link href="{{asset('assets/admin/layout2/css/themes/blue.css')}}" rel="stylesheet" type="text/css" id="style_color" />
...
{{--<link href="{{asset('assets/global/css/variables.scss')}}" rel="stylesheet" type="text/css"/>--}}
