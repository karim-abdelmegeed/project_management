$(document).on('ready pjax:success' , function () {
    $("select.select2").select2();
     ...
     if ($('.reorder').length) {
            var drake = dragula([$('#assignment-359 tbody')[0]]);
    ...
    $('#assignment-359search-form').on('click', function (e) {
    ...
    var assignment_359 = $('#assignment-359').DataTable({
        ...
        columns: column_data,
        ajax: {
            url: '/assignment2/assignment2_data',
            data: function (d) {
                $('.element').each(function () {
