...
$(document).on('click','.init_user_contract',function(e){
    appBlockUI();
  e.preventDefault();
  ...
  formData.append('contract_id', contract_id);
      $.ajax({
            url: '/signature/init_user_contract',
            method: 'post',
            data: formData,
            contentType: false,
       processData: false,
    ...
    var table = $('#n_d_as-211').DataTable(
        {
            "columnDefs": [
