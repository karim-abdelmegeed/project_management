$(document).on('ready pjax:success', function () {
    ...
    var table = $('#services-181').DataTable({
        'scrollX': true,
    ...
    table.buttons().container()
        .appendTo($('.hoppa', table.table().container()));
    ...
    // codeblock mandatory_locale   
    $("#mandatory_locale").change(function () {
        if ($(this).is(":checked")) {
            $("#mandatory_language").prop('checked', true);
        }
    });
    $("#mandatory_language").change(function () {
        if ($("#mandatory_locale").is(":checked")) {
            $("#mandatory_language").prop('checked', true);
        }
    });
//js-fn
