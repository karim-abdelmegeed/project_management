$(document).on('ready pjax:success', function () {
    ...
    var table = $('#subprojects-251').DataTable({
            'scrollX': true,
...
//
    var suppliers_table = $('#subproject_supplier').DataTable({
            'scrollX': true,
    ...
    suppliers_table.columns().search('').draw();
    var column_index = $("#amount").data('column-index');
    var start_range = $("input[name=start_range]").val();
    var end_range = $("input[name=end_range]").val();
    ...
    $(document).on('click', '#search-form', function () {
        suppliers_table.draw();
    });
    $(".filter").change(function () {
        suppliers_table.search('');
        $(this).each(function () {
            suppliers_table.column($(this).data('column-index')).search($(this).val()).draw();
        });
    });
    var ID;
    $(".num_range").slider({
    ...
    //
    var assign_suppliers_table = $('#assign_supplier_subproject').DataTable({
            'scrollX': true,
    ...
    assign_suppliers_table.columns().search('').draw();
    var column_index = $("#amount").data('column-index');
    var start_range = $("input[name=start_range]").val();
    var end_range = $("input[name=end_range]").val();
    ...
    $(document).on('click', '#search-form', function () {
        assign_suppliers_table.draw();
    });
    $(".filter").change(function () {
        assign_suppliers_table.search('');
        $(this).each(function () {
            assign_suppliers_table.column($(this).data('column-index')).search($(this).val()).draw();
        });
    });
    var ID;
    $(".num_range").slider({
