...
<script src="{{asset('assets/global/plugins/jrate/jRate.min.js')}}"></script>
...
<script src="{{asset('/js/amcharts/plugins/dataloader/dataloader.min.js')}}"></script>
@yield('plugins_js')
...
<script src="{{asset('assets/global/plugins/jstree/dist/jstree.js')}}"></script>
